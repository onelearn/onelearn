...
@njit(float32(get_type(TreeRegressor), uint32))
...
@njit(float32(get_type(TreeRegressor), uint32, uint32))
...
@njit(void(get_type(TreeRegressor), uint32, uint32, boolean))
...
@njit(void(get_type(TreeRegressor), uint32, float32, float32, uint32, boolean,))
